...
Function TSynHighlighter($self, $B) {
    switch($B[0]) {
        ...
        case 'PHP':
            $s = TSynT($self, array(
                    'Comment' => array('style' => 'fsBold', 'background' => 0xF8F8F8, 'foreground' => 0x659D11),
                    'Identifier' => array('style' => '', 'background' => 0xF8F8F8, 'foreground' => 0),
                    'key' => array('style' => 'fsBold', 'background' => 0xF8F8F8, 'foreground' => 0xFD6A51),
                    'Number' => array('style' => '', 'background' => 0xF8F8F8, 'foreground' => 0xAAAA00),
                    'Space' => array('style' => '', 'background' => 0xF8F8F8, 'foreground' => 236457567),
                    'String' => array('style' => '', 'background' => 0xF8F8F8, 'foreground' => 0xAAAA00),
                    'Symbol' => array('style' => 'fsBold', 'background' => 0xF8F8F8, 'foreground' => 0x8F4B07),
                    'Variable' => array('style' => 'fsBold', 'background' => 0xF8F8F8, 'foreground' => 0xFD6A51)
            ), $B[0]);
        break;
...
##################################################
Function SHTML() {
    highlighterSynEdit('synEditEx1', 'Edit.SynHTML');
}

Function SPHP() {
    highlighterSynEdit('synEditEx1', 'Edit.SynPHP');
}

Function SGeneral() {
    highlighterSynEdit('TSynEdit1', 'Edit.SynGeneral');
}

Function SCpp() {
    highlighterSynEdit('TSynEdit1', 'Edit.SynCpp');
}

Function SCss() {
    highlighterSynEdit('TSynEdit1', 'Edit.SynCss');
}

Function SSQL() {
    highlighterSynEdit('TSynEdit1', 'Edit.SynSQL');
}

Function SJScript() {
    highlighterSynEdit('TSynEdit1', 'Edit.SynJScript');
}

Function SXML() {
    highlighterSynEdit('TSynEdit1', 'Edit.SynXML');
}
